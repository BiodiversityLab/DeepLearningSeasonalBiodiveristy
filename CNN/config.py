...
class Settings(object):
    ...
    samples_file: Path = data_path / 'EXAMPLE_DATA.csv'

    # The path to cache for fast data loading
    cache_path: Path = data_path / 'cache'

    # The path where models and their outputs are stored
    ...
    num_workers: int = 14 # for parallelization

    # The default random seed to be used
    seed: int = 42

    # The default torch device to be used across the project
...
#
# """
# Below is the list of all features provided for the project.
# """
# all_feature_folders = [
#     GeoFeatureFolder(
#         name='days_up',
